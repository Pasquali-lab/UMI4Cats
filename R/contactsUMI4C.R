...
#' intermediate bams) (TRUE or FALSE, defaults to TRUE).
...
#' @inheritParams contactsUMI4C
#' @return Creates a compressed FASTQ file in \code{wk_dir/split} named
#' \code{basename(fastq)).fq.gz}, containing the splited reads based on the
...
.singleSplitUMI4C <- function(fastq_file,
  ...
  splited_fastq_name <- paste0(gsub("\\..*$", "", basename(fastq_file)),
                               ".fq.gz")
