...
#' Takes an UMI4c object and infer the differences between conditions of the smooth monotone fit values
#' using DESeq2 Wald Test from \code{\link[DESeq2]} package. 
...
#' The signal trend is fitted for the combined data left and right to the viewpoint using the \code{\link[fda]{fda}} package.
