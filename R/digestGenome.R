...
#'  directory named \code{digested_genome/} created in your working directory.
#' @return Creates a tab-delimited file in \code{out_path} named
#' "\code{ref_gen_name_RE.tsv}", containing the coordinates for all fragments
#' generated by digesting the genome using the given cutting sequences.
#' @examples
