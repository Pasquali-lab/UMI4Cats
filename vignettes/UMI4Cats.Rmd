...
In this case, the `UMI4C` object have to be creating grouped by samples id, setting the ``grouping="sampleID"` in `makeUMI4C()`.
...
4. Fit a curve to the dispersion estimates for calculating a VST 
