...
It is also possible to perform a differential analysis based on `DESeq2` Wald test. For carrying on this analysis is necessary replicates of the samples for estimating dispersions.

This differential analysis works as follow:

1. Variance stabilizing transformation of the raw counts
...
3. Fit a curve to the dispersion estimates for calculating the VST 
