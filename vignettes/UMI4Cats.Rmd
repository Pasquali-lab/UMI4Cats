...
## 4.1.1.) Perform differential test ---------------------------
umi <- fisherUMI4C(umi,
    filter_low = 30
)
...
## 5) DESeq2 test
# Load UMI-4C data and generate UMI4C object grouping by "sampleID"
umi <- makeUMI4C(
  colData = colData,
  viewpoint_name = "CIITA",
  grouping="sampleID")

## 5.1.1.) Perform DESeq2 differential test ---------------------------
umi <- differentialNbinomWaldTestUMI4C(umi4c=umi,
                                alpha = 100)

## 5,1.2.) Plot dispersions
plotDispEsts(dds)
...
plotUMI4C(umi_dif2, grouping = "condition")
```
