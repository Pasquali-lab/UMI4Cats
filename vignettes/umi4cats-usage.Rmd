...
```{r read-scheme, echo=FALSE, eval=TRUE, fig.cap="Schematic of a UMI-4C read detailing the different elements that need to be used as input for the processing of the data."}
...
Finally, the output (UMI-4C counts) is a compressed tsv file per sample that will be saved in `wk_dir/count`. These files will be the input for the data analysis in the following section.
