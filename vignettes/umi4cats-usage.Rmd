...
The function will consider all FastQ files in the same folder `fastq_dir` to be part of the same experiment (viewpoint + restriction enzyme). The paired-end FASTQ files in this folder have to present one of the follow extensions: _RX.fastq, _RX.fq, _RX.fq.gz or _RX.fastq.gz 
...
4. Algorithm for collapsing reads coming from same molecule, returnning all fragment ends 10Mb around the viewpoint(`umiCounterR`).
